...
const providers: Array<{ id: ProviderName; name: string; url: string }> = [
  { id: "gemini", name: "Gemini", url: "https://aistudio.google.com/apikey" },
