  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-5 py-10 sm:px-8">
      <Brand /><article className="prose prose-neutral mt-14 max-w-none dark:prose-invert">
        ...
        <h2>Availability</h2><p>The public demo is provided as-is and may be changed, rate-limited, or unavailable. Free-tier infrastructure may impose additional limits.</p>
