  ...
  return (
    <form action={action} className="space-y-5">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <div className="space-y-2"><Label htmlFor="company">Company *</Label><Input ref={companyRef} id="company" name="company" maxLength={100} defaultValue={initial?.company ?? ""} placeholder="Visa" required /></div>
        <div className="space-y-2"><Label htmlFor="role">Target role *</Label><Input ref={roleRef} id="role" name="role" maxLength={150} defaultValue={initial?.role ?? ""} placeholder="Senior SDET" required /></div>
