  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-5 py-10 sm:px-8">
      <Brand /><article className="prose prose-neutral mt-14 max-w-none dark:prose-invert">
        ...
        <h2>What NodeHire stores</h2><p>NodeHire stores your authentication profile and the company, role, job description, and optional notes you submit. Anonymous guest data expires after 30 days unless transferred to an account.</p>
